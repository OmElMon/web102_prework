...
const unfundedString = numUnfundedGames === 1 ? "game remains" : "games remain";

// use innerHTML to set the description container's HTML to the string
const description = `
  We have raised $${totalRaised.toLocaleString("en-US")} for ${GAMES_JSON.length} games.
  Currently, ${numUnfundedGames} ${unfundedString} unfunded.
`;
